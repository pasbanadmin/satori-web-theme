<section class="bg-[#f7f3eb] py-16 lg:py-24" data-opening-statement>
  <div class="mx-auto w-full max-w-4xl px-5 text-center sm:px-8">
    ...
    <span class="mx-auto mt-5 block h-px w-12 bg-brand-gold" data-reveal></span>
    ...
    <div class="mx-auto my-8 h-px w-full max-w-[16rem] bg-brand-gold" data-divider></div>
  </div>
</section>
