@php
  $luxuryImage = '/wp-content/uploads/2026/08/SATORI-round-2-04-scaled.webp';
  ...
  <div class="mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-16">
    <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
      <div class="group relative overflow-hidden" data-reveal>
        <img class="aspect-[4/3] w-full object-cover transition-transform duration-[1200ms] ease-out group-hover:scale-105" src="{{ $luxuryImage }}" alt="{{ $luxuryAlt }}">
      ...
      <div class="lg:py-8" data-reveal>
        <div class="flex items-baseline gap-4">
          <span class="font-heading text-3xl font-light leading-none text-brand-gold/60">01</span>
