<section class="bg-[#f7f3eb] py-24">
  <div class="mx-auto w-full max-w-4xl px-5 text-center sm:px-8">
    ...
    <blockquote class="mt-14 font-heading text-2xl font-light leading-tight text-brand-ink sm:text-3xl" data-reveal>
    ...
    <div class="mx-auto my-16 flex items-center justify-center gap-4" data-reveal aria-hidden="true">
