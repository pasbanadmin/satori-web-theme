<section class="bg-[#f7f3eb] py-16 lg:py-24">
  <div class="mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-16">
    ...
    <div class="grid gap-8 lg:grid-cols-2 lg:gap-12" data-reveal>
      
      {{-- Card A: Book a home --}}
      <div class="flex flex-col justify-between border border-brand-ink/15 bg-white p-8 sm:p-10 transition-shadow duration-300 hover:shadow-lg">
        <div>
        ...
        <div class="mt-8 pt-6 border-t border-brand-ink/10">
          <a href="#book" class="inline-flex items-center justify-center gap-2 rounded-full bg-brand-gold px-7 py-3.5 text-xs uppercase tracking-[0.2em] font-medium text-brand-primary transition-colors duration-300 hover:bg-brand-primary hover:text-brand-sand">
      ...
      <div class="flex flex-col justify-between border border-brand-gold/40 bg-brand-sand p-8 sm:p-10 transition-shadow duration-300 hover:shadow-lg">
        <div>
          <p class="text-[0.7rem] uppercase tracking-[0.25em] text-brand-gold font-medium">
        ...
        <div class="mt-8 pt-6 border-t border-brand-ink/10">
          <a href="#enquire-form" class="inline-flex items-center justify-center gap-2 rounded-full border border-brand-ink/30 px-7 py-3.5 text-xs uppercase tracking-[0.2em] font-medium text-brand-ink transition-colors duration-300 hover:border-brand-gold hover:bg-brand-gold hover:text-brand-primary">
    ...
    <div class="mt-16 lg:mt-24 border-t border-brand-ink/15 pt-14 lg:pt-20" data-reveal>
      ...
      <div class="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <div class="border border-brand-ink/10 bg-white/60 p-6 text-center">
          <div class="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-brand-gold/15 text-brand-gold mb-4">
