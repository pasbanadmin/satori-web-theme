<section class="bg-brand-primary text-brand-sand py-20 lg:py-28">
  <div class="mx-auto w-full max-w-4xl px-5 text-center sm:px-8" data-reveal>
    ...
    <p class="mt-8 font-heading text-xl font-light italic text-brand-gold">
      {{ __('Satori is built for exactly that.', 'sage') }}
    </p>
  </div>
</section>
