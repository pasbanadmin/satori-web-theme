...
<section id="gatherings" class="relative flex min-h-[32rem] items-center overflow-hidden bg-brand-primary text-brand-sand lg:min-h-[40rem]" data-gatherings>
  ...
  <div class="relative z-10 mx-auto w-full max-w-4xl px-5 py-28 text-center sm:px-8 lg:py-36">
    <p class="text-[0.75rem] uppercase tracking-[0.3em] text-brand-gold" data-gatherings-item>
      {{ __('Gatherings', 'sage') }}
    </p>

    <h2 class="mt-5 font-heading text-4xl font-light leading-tight text-brand-sand sm:text-5xl" data-gatherings-item>
    ...
    <a class="mt-10 inline-flex items-center justify-center gap-2 rounded-full border border-brand-gold px-8 py-4 text-[0.8125rem] uppercase tracking-[0.2em] text-brand-gold transition-colors duration-300 hover:bg-brand-gold hover:text-brand-primary" href="#gatherings" data-gatherings-item>
